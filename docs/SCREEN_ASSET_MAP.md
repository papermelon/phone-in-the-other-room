...
| Protected Night | CompletionView, OllieRitualView, RewardCard, bookend split | proud Ollie, two bookend icons, reward reveal | `OllieRitualView(.completed)` + reward art | `dog_proud`, `dog_happy`, `ui_modal_reward_sheep`, `sheep_common_white` |
