...
enum FarmShopCatalog {
    ...
    private static let ollieItems: [FarmShopItem] = [
        FarmShopItem(id: "fetch_ball_moss", title: "Moss Ball", detail: "A leafy green ball for clover practice and free fetch. Same bounce, fresh colour.", category: .ollie, woolCost: 3, symbolName: "tennisball.fill", visualStyle: "grass", effect: .fetchBall),
        FarmShopItem(id: "fetch_ball_sunset", title: "Sunset Ball", detail: "A warm berry ball for evenings with Ollie. Same throw, a different look.", category: .ollie, woolCost: 4, symbolName: "tennisball.fill", visualStyle: "berry", effect: .fetchBall),
        ...
        FarmShopItem(id: "ollie_brass_bell", title: "Brass Farm Bell", detail: "A little brass bell on Ollie’s collar.", category: .ollie, woolCost: 4, symbolName: "bell.fill", inventoryAssetName: "shop/shop_ollie_classic_brass_trail_bell", equippedRenderAsset: .ollieAccessory(overlayAssetName: "dog/dog_classic_farm_brass_trail_bell_equipped_overlay"), visualStyle: "amber", effect: .ollieAccessory),
