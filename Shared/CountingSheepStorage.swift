...
enum CountingSheepOwnedStorage {
    static let standardKeys: [String] = [
        ...
        "ollie.nightFlock.sharedHabitsPrivacyFences",
        "ollie.nightFlock.sharedHabitsOutbox",
        "ollie.nightFlock.sharedHabitsPendingProjections",
        "ollie.nightFlock.sharedHabitsAgreementAttempts",
        "ollie.nightFlock.sharedHabitsSleepPublicationLedger",
