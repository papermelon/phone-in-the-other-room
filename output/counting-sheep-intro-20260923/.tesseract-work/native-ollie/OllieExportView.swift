...
struct OllieDressedSprite: View {
    ...
    var body: some View {
        Group {
            if let baseImage = NSImage(contentsOfFile: Self.assetPath(assetName)) {
                ...
                Image(systemName: "pawprint.fill")
                    .resizable().scaledToFit().foregroundStyle(Color.green)
                    .padding(8)
            }
        }
    ...
    private static func assetPath(_ name: String) -> String {
